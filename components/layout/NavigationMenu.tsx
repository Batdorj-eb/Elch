    ...
    <nav className="bg-[#FFF1E5] lg:bg-zinc-800 text-[#2F2F2F] lg:text-white sticky top-0 z-50 py-2 md:py-3 lg:py-0">
      ...
      {mobileMenuOpen && (
        ...
        >
          ...
          >
            <div className="absolute inset-0 bg-white p-4 overflow-y-auto max-h-screen">
              {/* Close button (visible inside panel at top-right) */}
              ...
              {/* Top info row */}
              <div className="flex justify-between items-center gap-5 font-[10px] mb-2">
              ...
              <div className="mt-2">
                {visibleCategories.map((category, idx) => (
                  <Link
                    ...
                    href={`/${category.slug}`}
                    onClick={() => setMobileMenuOpen(false)}
                    className="block px-4 py-3 text-sm hover:bg-zinc-100 transition rounded"
